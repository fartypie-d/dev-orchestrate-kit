...
# Once per machine — harness/providers are auto-detected or asked interactively if omitted
./install.sh --claude --providers=qwen,openai --plan=max20 typescript python

# Per project — pick one of the two entry points
...
The kit itself ships under [MIT](./LICENSE).
